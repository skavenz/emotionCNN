...
Issues to address: Using PyPlot's subplots, I have identified that the model has overfitting issues as the validation accuracy tends to converge as the training accuracy continues to go up, meaning the results are less general and are over-tailored towards the training dataset.
